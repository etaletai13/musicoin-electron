...
PropertyChangeSupport.prototype.firePropertyChange = function (
  prop,
  oldValue,
  newValue
) {
...
PropertyChangeSupport.prototype.addObservable = function (
  prop,
  defaultValue,
  alwaysNotify
) {
...
PropertyChangeSupport.prototype.attach = function (watcher) {
  ...
  return {
    to: function (prop, fn) {
      if (!fn) {
        fn = function (oldValue, newValue) {
          watcher[prop] = newValue
        }
      } else if (Object.prototype.toString.call(fn) === '[object String]') {
        var alias = fn
        fn = function (oldValue, newValue) {
          watcher[alias] = newValue
        }
      }
